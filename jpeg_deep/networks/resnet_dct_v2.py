...
def late_concat_rfa_v2(input_shape=(28, 28), classes: int = 1000):
    ...
    y = conv_block(y, 3, [256, 256, 1024], stage=3, block='a_y')
...
def late_concat_rfa_thinner_v2(input_shape=(28, 28), classes=1000):
    if input_shape is None:
        input_shape_y = (None, None, 64)
        input_shape_cbcr = (None, None, 128)
    else:
    ...
    y = conv_block(y, 3, [256, 256, 768], stage=3, block='a_y')

    bn_cbcr = BatchNormalization(
        axis=bn_axis, momentum=0.9, epsilon=1e-5, name='bn_cbcr')(input_cbcr)
    cbcr = conv_block(bn_cbcr, 1, [256, 256, 256],
                      stage=1, block='a_cbcr', strides=(1, 1))
...
def deconvolution_rfa_v2(input_shape=(28, 28), classes: int = 1000):
    if input_shape is None:
        input_shape_y = (None, None, 64)
