...
def convert_coordinates(tensor: object, start_index: int, conversion:str, border_pixels:str='half'):
    '''
    ...
    - (xmin, xmax, ymin, ymax) - the 'minmax' format
    - (xmin, ymin, xmax, ymax) - the 'corners' format
    - (cx, cy, w, h) - the 'centroids' format

    # Arguments:
        - tensor: A Numpy nD array containing the four consecutive coordinates to be converted somewhere in the last axis.
        - start_index: The index of the first coordinate in the last axis of `tensor`.
        - conversion: The conversion direction. Can be 'minmax2centroids', 'centroids2minmax', 'corners2centroids', 'centroids2corners', 'minmax2corners', or 'corners2minmax'.
...
def intersection_area(boxes1:object, boxes2:object, coords:str='centroids', mode:str='outer_product', border_pixels:str='half'):
    '''
    ...
    Arguments:
        - boxes1: Either a 1D Numpy array of shape `(4, )` containing the coordinates for one box in the
        ...
        - boxes2: Either a 1D Numpy array of shape `(4, )` containing the coordinates for one box in the
            format specified by `coords` or a 2D Numpy array of shape `(n, 4)` containing the coordinates for `n` boxes.
            If `mode` is set to 'element_wise', the shape must be broadcast-compatible with `boxes1`.
        - coords : The coordinate format in the input arrays. Can be either 'centroids' for the format
            `(cx, cy, w, h)`, 'minmax' for the format `(xmin, xmax, ymin, ymax)`, or 'corners' for the format
            `(xmin, ymin, xmax, ymax)`.
        - mode : Can be one of 'outer_product' and 'element-wise'. In 'outer_product' mode, returns an
    ...
    if not (boxes1.shape[1] == boxes2.shape[1] == 4):
        raise ValueError("All boxes must consist of 4 coordinates, but the boxes in `boxes1` and `boxes2` have {} and {} coordinates, respectively.".format(
...
def intersection_area_(boxes1:object, boxes2:object, coords:str='corners', mode:str='outer_product', border_pixels:str='half'):
    '''
...
def iou(boxes1: object, boxes2: object, coords:str='centroids', mode:str='outer_product', border_pixels:str='half'):
    '''
