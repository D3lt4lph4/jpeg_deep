'''
A custom tensorflow.keras layer to decode the raw SSD prediction output. This is a modified
...
class DecodeDetections(Layer):
    ...
    def call(self, array, mask=None):
        ...
        if self.dct:
            ...
            ymin = cy - 0.5 * h * h_size * 8
            xmax = cx + 0.5 * w * w_size * 8
            ymax = cy + 0.5 * h * h_size * 8
        else:
