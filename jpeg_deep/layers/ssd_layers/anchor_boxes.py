...
class AnchorBoxes(Layer):
    ...
    def __init__(self,
        ...
        if (1 in aspect_ratios) and True:
    ...
    def call(self, x, mask=None):
        ...
        to convert the resulting Numpy array into a tensorflow.keras tensor at the very end before outputting it.
