...
from jpeg_deep.networks import late_concat_rfa
...
class TrainingConfiguration(object):
    ...
    def __init__(self):
        ...
        self.description = "Training configuration file for ResNet lcrfa network."
        ...
        self._workspace = "classification_lcrfa"

        # Network variables
        self._weights = None
        self._network = late_concat_rfa()
    ...
    def prepare_for_inference(self):
        K.clear_session()
        self._network = late_concat_rfa(input_shape=None)
