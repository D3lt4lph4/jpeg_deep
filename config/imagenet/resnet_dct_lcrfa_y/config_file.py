...
from jpeg_deep.networks import late_concat_rfa_y
...
class TrainingConfiguration(object):
    ...
    def __init__(self):
        ...
        self.description = "Training configuration file for ResNet lcrfa y network."
        ...
        self._workspace = "classification_lcrfa_y"

        # Network variables
        self._weights = None
        self._network = late_concat_rfa_y()
    ...
    def prepare_for_inference(self):
        K.clear_session()
        self._network = late_concat_rfa_y(input_shape=None)
