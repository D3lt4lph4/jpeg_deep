...
from dctvgg.networks import VGG16_A, VGG16_D
from dctvgg.networks import VGG16_A_Initial, VGG16_A_Deconvolution
from dctvgg.networks import VGG16_D_Initial, VGG16_D_Deconvolution
from dctvgg.networks import VGG16AInitialBNAfter
from dctvgg.networks import VGG16AInitialNoBN
from dctvgg.generators import DummyGenerator
from dctvgg.evaluation import Evaluator
...
class TrainingConfiguration(TemplateConfiguration):
    ...
    def __init__(self):
        ...
        self.early_stopping_params = {"monitor":'val_loss', "min_delta":0, "patience":8}
        ...
        self._callbacks = [self.terminate_on_nan,
                          self.early_stopping, self.reduce_lr_on_plateau]

        # Creating the training and validation generator
        self.num_batches = 100
        self._train_generator = DummyGenerator(self.num_batches, self.batch_size)
        self._validation_generator = DummyGenerator(self.num_batches, self.batch_size)
        self._test_generator = DummyGenerator(self.num_batches, self.batch_size)
