...
class TrainingConfiguration(object):
    ...
    def __init__(self):
        ...
        self._network = SSD300_resnet(
            n_classes=80, scales=[0.07, 0.15, 0.33, 0.51, 0.69, 0.87, 1.05], backbone="lcrfa")
    ...
    def prepare_for_inference(self):
        K.clear_session()
        self._network = SSD300_resnet(
            n_classes=80, scales=[0.07, 0.15, 0.33, 0.51, 0.69, 0.87, 1.05], backbone="lcrfa", mode="inference")

    def prepare_evaluator(self):
        self._evaluator = CocoEvaluator(
            self.validation_annotation_path, set="val2017", alg="lcrfa")
