...
class TrainingConfiguration(object):
    ...
    def __init__(self):
        ...
        # Network variables
        self._weights = None
        self._network = SSD300(n_classes=80)
    ...
    def prepare_testing_generator(self):
        self._test_generator = COCOGenerator(self.train_image_dir, self.train_annotation_path, batch_size=self.batch_size, shuffle=False, label_encoder=self.input_encoder,
