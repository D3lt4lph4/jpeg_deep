...
class TrainingConfiguration(object):
    ...
    def __init__(self):
        ...
        self._network = SSD300(
            n_classes=80, backbone="VGGDCT", dct=True, image_shape=(38, 38), scales=[0.07, 0.15, 0.33, 0.51, 0.69, 0.87, 1.05])
    ...
    def prepare_for_inference(self):
        K.clear_session()
        self._network = SSD300(
            n_classes=80, backbone="VGGDCT", dct=True, image_shape=(38, 38), scales=[0.07, 0.15, 0.33, 0.51, 0.69, 0.87, 1.05], mode="inference")

    def prepare_evaluator(self):
        self._evaluator = CocoEvaluator(
            self.validation_annotation_path, set="val2017", alg="ssd-dct")
